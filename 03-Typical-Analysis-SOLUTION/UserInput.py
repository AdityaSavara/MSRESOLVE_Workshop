...
UserChoices['timeRangeLimit']['timeRangeStart'] = 775  #start time (-int)
UserChoices['timeRangeLimit']['timeRangeFinish'] = 1075	#finish time (-int)
...
UserChoices['linearBaselineCorrectionSemiAutomatic']['earlyBaselineTimes'] = [[800,850]]	# to apply different times for each fragment enter time pairs as such [[x,y],[z,w]..]
# to apply a uniform time range to all fragments, only insert one time range [[x,y]]
UserChoices['linearBaselineCorrectionSemiAutomatic']['lateBaselineTimes'] = [[1000,1050]]	#if you do not wish to enter a second time list enter 0's [[0,0],[0,0]...] or [[0,0]]
...
UserChoices['applyReferenceMassFragmentsThresholds']['referenceMassFragmentFilterThreshold'] = [0]
